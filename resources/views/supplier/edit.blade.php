                ...
                <div class="card">
                    <div class="card-body">
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" value="{{ $supplier->company_name }}" name="company_name" id="horizontal-firstname-input" required>
                            </div>
                        </div>
                        <div class="form-group row mb-4">
                            <label for="horizontal-firstname-input1" class="col-sm-4 col-form-label">Contact Person</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" value="{{ $supplier->person_name }}" name="person_name" id="horizontal-firstname-input1" required>
                            </div>
                        </div>
                        <div class="form-group row mb-4">
                            <label for="horizontal-firstname-input2" class="col-sm-4 col-form-label">Code</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" value="{{ $supplier->code }}" name="code" id="horizontal-firstname-input2">
                            </div>
                        </div>
                        <div class="form-group row mb-4">
                            <label for="horizontal-firstname-input3" class="col-sm-4 col-form-label">Mobile Number</label>
                            <div class="col-sm-8">
                                <input type="number" class="form-control" value="{{ $supplier->mobile }}" name="mobile" id="horizontal-firstname-input3" required>
                            </div>
                        </div>
                        <div class="form-group row mb-4">
                            <label for="horizontal-firstname-input4" class="col-sm-4 col-form-label">Email Address</label>
                            <div class="col-sm-8">
                                <input type="email" class="form-control" value="{{ $supplier->email }}" name="email" id="horizontal-firstname-input4">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-8">
                                ...
                                <img src="{{ asset($supplier->logo) }}" alt="" height="50" width="50">
                            </div>
                        </div>
                        <div class="form-group row mb-4">
                            <label for="horizontal-firstname-input7" class="col-sm-4 col-form-label">Account Number</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" value="{{ $supplier->account_number }}" name="account_number" id="horizontal-firstname-input7">
                            </div>
                        </div>
                        <div class="form-group row mb-4">
                            <label for="horizontal-firstname-input6" class="col-sm-4 col-form-label">Address</label>
                            <div class="col-sm-8">
                                <textarea class="form-control" name="address" id="horizontal-firstname-input6">{{ $supplier->address }}</textarea>
                            </div>
                        </div>
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-8">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" {{ $supplier->status == 1 ? 'checked' : '' }}  name="status" id="inlineRadio1" value="1">
                                    <label class="form-check-label" for="inlineRadio1">Published</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" {{ $supplier->status == 0 ? 'checked' : '' }} name="status" id="inlineRadio2" value="0">
        ...
        <div class="com-md-12">
            <div class="card card-body pb-1">
                <div class="form-group row justify-content-end">
                    <div class="col-sm-12">
                        <div>
                            <button type="submit" class="btn btn-primary btn-block w-md">Update Supplier</button>
                        </div>
                    </div>
                </div>
            </div>
